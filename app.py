...
def recommend_courses_with_sbert(resume_text):
    ...
    # Compute embeddings
    course_embeddings = sbert_model.encode(courses_df['Combined_Info'].tolist(), convert_to_tensor=True)
    user_embedding = sbert_model.encode([resume_keywords], convert_to_tensor=True)
    ...
    # Priority logic depends on strong_courses and weak_courses (populated later)
